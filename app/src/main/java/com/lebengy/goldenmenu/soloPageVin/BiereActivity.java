...
import com.lebengy.goldenmenu.model.Biere;
...
public class BiereActivity extends AppCompatActivity {
    ...
    public void fetchVins() {
        this.db.collection("Biere").addSnapshotListener(new EventListener<QuerySnapshot>() { // from class: com.lebengy.goldenmenu.soloPageVin.BiereActivity.1
            ...
            public void onEvent(QuerySnapshot value, FirebaseFirestoreException e) {
                ...
                BiereActivity.this.listRurale = new ArrayList();
                ...
                while (it.hasNext()) {
                    ...
                    if (next.getString("brasseur").equals("401DONJO")) {
                        ...
                        BiereActivity.this.listRurale.add(BiereActivity.this.unserializeBiere(next));
                    }
                }
    ...
    public void dispoVins() {
        ...
        Collections.sort(this.listRurale);
        for (int i2 = 0; i2 < this.listRurale.size() && i2 < 10; i2 += 1) {
            Biere biere2 = this.listRurale.get(i2);
